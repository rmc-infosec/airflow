...
# under the License.
"""
Fuzzer for DAG serialization/deserialization.

This targets SerializedDAG.from_dict() which is used by the Scheduler and
API Server to load serialized DAGs. The security boundary is the schema
validation and type checking during deserialization.

Target: airflow.serialization.serialized_objects.SerializedDAG
Security boundary: Schema validation
"""
